...
class TicketingManager(object):
    ...
    def initiate_order_payment(form, paid_via=None):
        ...
        if order:
            ...
            holders_job_title = form.getlist('holders[job_title]')
            holders_phone_no = form.getlist('holders[phone_no]')
            holders_work_phone = form.getlist('holders[work_phone]')
            holders_mobile_phone = form.getlist('holders[mobile_phone]')
            holders_tax_business_info = form.getlist('holders[tax_business_info]')
            #holders_billing_address = form.getlist('holders[billing_address]')
            holders_work_address = form.getlist('holders[work_address]')
            holders_shipping_address = form.getlist('holders[shipping_address]')
            holders_home_address = form.getlist('holders[home_address]')
            holders_organisation = form.getlist('holders[organisation]')
            holders_website = form.getlist('holders[website]')
            holders_blog = form.getlist('holders[blog]')
            holders_twitter = form.getlist('holders[twitter]')
            holders_facebook = form.getlist('holders[facebook]')
            holders_git_repo = form.getlist('holders[git_repo]')
            holders_gender = form.getlist('holders[gender]')
            holders_dob = form.getlist('holders[dob]')
